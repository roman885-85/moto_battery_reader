...
// Анімація батареї на головній сторінці (пульсація заповнення). УВІМКНЕНА типово.
// Якщо на вашій панелі вона заважає — розкоментуйте, щоб ВИМКНУТИ (решта
// дисплея працює однаково):
