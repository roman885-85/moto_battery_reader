...
//
//  ПОТУЖНІСТЬ. На 5 Ом: 8.4 В -> 1.68 А -> 14.1 Вт; 7.0 В -> 1.40 А -> 9.8 Вт.
//  Резистор потрібен на 25 Вт із радіатором. MOSFET працює КЛЮЧЕМ (повністю
//  відкритий), у лінійному режимі його не тримаємо — інакше вихід за SOA.
//
...
// Опір навантаження, Ом — лише для оцінки очікуваного струму в інтерфейсі.
// На облік мА*год не впливає: він рахується з РЕАЛЬНОГО струму DS2438.
