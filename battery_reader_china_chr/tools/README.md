...
| `charge_logic_check` | заряд на СПРАВЖНЬОМУ `charge.h`: профіль струму, регулятор шпаруватості, стартова точка понижувача, вимір струму/напруги, тепловий бюджет біполярного ключа |
