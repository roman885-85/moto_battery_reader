...
// Аппаратный I2C — рендер в ~10 раз быстрее. Если с ним дисплей не
// заработал — сначала снизьте частоту шины ниже до 100 (длинные провода).
// #define DISPLAY_HW_I2C
#define DISPLAY_I2C_KHZ   400    // частота шины I2C, кГц (100..400)
