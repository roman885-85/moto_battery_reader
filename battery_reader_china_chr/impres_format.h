...
inline void impresResetMonitor(uint8_t *d38, const uint8_t *d33, uint8_t ica) {
    ...
    d38[0x07] = 0x40;                       // поріг
    // ⚑ Разом із наробітком обнуляються МІТКИ ПОДІЙ (див. impresSetEtm). Доти
    //  вони лишались від старого життя пакета, і станція відновлювала з них
    //  наробіток — саме це видно в dumps/13: у нас 234 c, після станції 923 доби.
    impresSetEtm(d38, 0);
