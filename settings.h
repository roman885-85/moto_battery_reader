...
// Анімація батареї на головній сторінці (пульсація заповнення). Якщо після її
// появи дисплей поводиться дивно — розкоментуйте, щоб ВИМКНУТИ анімацію
// (решта дисплея працює як раніше):
